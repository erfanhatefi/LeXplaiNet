...
def preserve_forward_with_modified_gradient(
    original_output: torch.Tensor, gradient_proxy: torch.Tensor
):
    """
...
# # Backward-compatible alias used by existing rule imports/calls.
# safe_forward_rescale = preserve_forward_with_modified_gradient
